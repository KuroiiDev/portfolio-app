...
const HeroSection = () => {
    const handleDownload = async (e) => {
        ...
        const fileId = "1bckJb02idQErGzvqycnHpHzmwAv-zIto";
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12">
                ...
                >
                    <h1 className="text-white mb-4 text-3xl sm:text-1xl lg:text-6xl lg:leading-normal font-extrabold">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-info-400 to-primary-500">
                            Hello, I&apos;m{" "}
                        </span>
                        <br></br>
                        <TypeAnimation
                    ...
                    <div>
                        ...
                        <Link
                            href="/#projects"
                            className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-info-500 via-secondary-500 to-primary-500 hover:bg-slate-800 text-white mt-3"
                        >
